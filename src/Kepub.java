...
public class Kepub {
    ...
    public static String kepubify(String s) {
        ...
        while (pos < end) {
            ...
            while (true) {
                if (ss[pos] == '<' && ss[pos + 1] == '/' &&
                    ...
                    out.append("<span class=\"koboSpan\" id=\"kobo.").append(kePara).append(".").append(keSpan).
                    ...
                    if (pos - spanStart < MIN_SPAN || Character.isLowerCase(ss[pos])) endS = false;
                    else {
                        out.append("<span class=\"koboSpan\" id=\"kobo.").append(kePara).append(".").append(keSpan).
                    ...
                    if (tags < 0) Err.fatal2("tags are messed up");
                }
        ...
        if (!pFinished) Err.fatal2("for kepub, paragraph must be contained in one line");
        return out.toString();
    }
